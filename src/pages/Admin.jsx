...
export default function Admin() {
  ...
  const fetchUrls = () => {
    axios
      .get(`${process.env.REACT_APP_API_URL}/admin/urls`)
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <button
          ...
          className={`p-2 sm:p-3 rounded-full transition-transform duration-200 hover:scale-110 ${
      ...
      {urls.length === 0 ? (
        ...
        <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {urls.map((url) => {
            const shortUrl = `${process.env.REACT_APP_API_URL}/${url.shortCode}`;
            ...
            return (
              <div
                key={url._id}
                className={`relative rounded-xl sm:rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-4 sm:p-6 border ${
                  darkMode
              ...
              >
                <div className="mb-3 sm:mb-4">
                  ...
                  <a
                    ...
                    title={url.longUrl}
                    className={`block mt-1 text-sm sm:text-base font-medium break-all hover:underline ${
                ...
                <div className="mb-3 sm:mb-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-1">
                    ...
                    <button
                      ...
                      className={`px-3 py-1 text-xs sm:text-sm rounded-lg shadow transition ${
                        darkMode
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`px-3 py-1 text-xs sm:text-sm rounded-full font-semibold shadow ${
                      darkMode
